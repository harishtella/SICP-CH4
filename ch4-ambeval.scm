...
'(define (eight-queens)
  ...
  (let ((q1 (cons (amb 'a 'b 'c 'd 'e 'f 'g 'h)
				  (amb 1 2 3 4 5 6 7 8)))
		(q2 (cons (amb 'a 'b 'c 'd 'e 'f 'g 'h)
				  (amb 1 2 3 4 5 6 7 8)))
		(q3 (cons (amb 'a 'b 'c 'd 'e 'f 'g 'h)
				  (amb 1 2 3 4 5 6 7 8)))
		(q4 (cons (amb 'a 'b 'c 'd 'e 'f 'g 'h)
				  (amb 1 2 3 4 5 6 7 8)))
		(q5 (cons (amb 'a 'b 'c 'd 'e 'f 'g 'h)
				  (amb 1 2 3 4 5 6 7 8)))
		(q6 (cons (amb 'a 'b 'c 'd 'e 'f 'g 'h)
				  (amb 1 2 3 4 5 6 7 8)))
		(q7 (cons (amb 'a 'b 'c 'd 'e 'f 'g 'h)
				  (amb 1 2 3 4 5 6 7 8)))
		(q8 (cons (amb 'a 'b 'c 'd 'e 'f 'g 'h)
				  (amb 1 2 3 4 5 6 7 8))))
	(require (distinct? (list q1 q2 q3 q4 q5 q6 q7 q8)))
	(require (reduce and 
					 (map safe? (choose2 (list q1 q2 q3 q4 q5 q6 q7 q8))))) 
